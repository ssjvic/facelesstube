...
export const VIDEO_TEMPLATES = [
  ...
  },
  {
    ...
    icon: "🔍",
    color: "#78350f",
    description: "Casos reales de crimen y misterio",
  },
];
...
export const VIRAL_IDEAS = {
  ...
  crimen: [
    "El asesino que la policía tuvo enfrente y no se dio cuenta",
    "El caso que se resolvió por un error del criminal en redes sociales",
    "La desaparición que mantiene en vilo a un país entero",
    "El robo perfecto que casi funciona",
    "El detective que se obsesionó tanto que cruzó la línea",
    "La evidencia que encontraron 30 años después",
    "El secuestro más extraño de la historia moderna",
    "La confesión que nadie esperaba en pleno juicio",
    "El caso que se resolvió gracias a un perro",
    "La llamada al 911 que heló la sangre de todo el mundo",
  ],
};
