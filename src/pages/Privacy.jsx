...
Al solicitar la eliminación de tu cuenta, todos tus datos asociados serán eliminados permanentemente en un plazo máximo de 7 días.
...
Upon requesting account deletion, all associated data will be permanently deleted within a maximum of 7 days.
...
Ao solicitar a exclusão de sua conta, todos os dados associados serão excluídos permanentemente em um prazo máximo de 7 dias.
...
Lors d'une demande de suppression de compte, toutes les données associées seront définitivement supprimées dans un délai maximum de 7 jours.
...
Bei Beantragung der Kontolöschung werden alle zugehörigen Daten innerhalb von maximal 7 Tagen dauerhaft gelöscht.
