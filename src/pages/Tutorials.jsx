    ...
    const tutorials = [
        {
            ...
            views: '45k',
            category: 'Estrategia',
            thumbnail: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=400&h=225&auto=format&fit=crop'
        },
        {
            ...
            thumbnail: 'https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?q=80&w=400&h=225&auto=format&fit=crop'
        },
        {
            ...
            views: '28k',
            category: 'Contenido',
            thumbnail: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?q=80&w=400&h=225&auto=format&fit=crop'
        },
        {
            ...
            views: '89k',
            category: 'Dinero',
            thumbnail: 'https://images.unsplash.com/photo-1621643135540-309d437021e1?q=80&w=400&h=225&auto=format&fit=crop'
        }
    ]
    ...
    const niches = [
        {
            ...
            description: 'Altamente viral y gran retención. Usa clips de parkour o Minecraft.',
            icon: '👹',
            cpm: 'Medio'
        },
        {
        ...
        },
        {
            ...
            description: 'Gran nicho para afiliados de desarrollo personal y finanzas.',
            icon: '🚀',
            cpm: 'Muy Alto'
        },
        {
                ...
                <div className="lg:col-span-2 space-y-4 md:space-y-8">
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3 md:gap-6">
                            {tutorials.map((video, i) => (
                                <div key={i} className="glass-card group cursor-pointer overflow-hidden p-0">
                                    ...
                                    <div className="p-4">
                                        <div className="flex items-center gap-2 mb-2">
                                            <span className="text-[10px] uppercase font-bold text-aurora-teal">{video.category}</span>
                                            <span className="text-white/20 text-xs">•</span>
                                            <span className="text-[10px] text-white/40">{video.views} vistas</span>
                                        </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {niches.map((niche) => (
                                <div key={niche.id} className="p-4 rounded-2xl glass-card border-white/5 hover:border-aurora-magenta/30 transition-all flex gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-white/50 mb-2">{niche.description}</p>
                                        <div className="flex items-center gap-1">
                                            <TrendingUp size={12} className="text-aurora-green" />
                                            <span className="text-[10px] font-bold text-aurora-green uppercase">CPM {niche.cpm}</span>
                                        </div>
                                    </div>
                                </div>
                            ))}
                ...
                <div className="space-y-4 md:space-y-8">
                    ...
                    <div className="glass-card">
                        ...
                        <div className="space-y-4">
                            {tips.map((tip, i) => (
                                <div key={i} className="p-3 rounded-xl bg-cosmic-800/50 border border-white/5">
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-xs font-bold text-aurora-violet">{tip.user}</span>
                    ...
                    <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-aurora-teal/20 to-aurora-violet/20 border border-white/10 text-center">
                        ...
                        <p className="text-xs text-white/60 mb-4">Comparte tus resultados y aprende de otros canales automatizados.</p>
                        <a href="https://t.me/facelesstubeapp" target="_blank" rel="noopener noreferrer" className="text-xs text-aurora-teal font-bold hover:underline">
