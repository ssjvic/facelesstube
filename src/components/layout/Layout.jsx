...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex bg-cosmic-950 overflow-x-hidden">
      ...
      {/* Mobile header */}
      <div
        className="lg:hidden fixed top-0 left-0 right-0 z-50 glass border-b border-white/10 px-3 py-2 flex items-center justify-between"
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            <img src="/logo.png" alt="FacelessTube" className="h-11 w-auto" />
          </div>
      ...
      <main className="flex-1 lg:ml-0 min-h-screen relative z-10 overflow-x-hidden min-w-0">
        <div
          className="p-3 sm:p-4 lg:p-10 lg:pt-10 pb-8"
          style={{
